...
public class H_W_WebElement_UX {
...
//        FileUtils.copyFile(file, new File("nameField.png")); //Physical File in Project
        ...
        System.out.println("Height of the WebElement is: " + nameField.getRect().getDimension().getHeight());
        System.out.println("Width of the WebElement is: " + nameField.getRect().getDimension().getWidth());
	}
